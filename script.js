    ...
    window.tram = (function (t) {
        ...
        Ce = H(function (e) {
          ...
          function i() {
            var d,
              ...
              ne = R.length;
            if (ne)
              for (G(i), M = fe(), d = ne; d--; ) (D = R[d]), D && D.render(M);
          }
          function o(d) {
            var M,
              D = t.inArray(d, R);
            ...
            (e.render = function (d) {
              ...
              if (D < this.duration) {
                ...
                return (
                  ...
                  (this.value = M + this.unit),
                  void this.update.call(this.context, this.value)
                );
              }
              (M = this.endHex || this.begin + this.change),
                (this.value = M + this.unit),
                this.update.call(this.context, this.value),
                this.complete.call(this.context),
                this.destroy();
            }),
            (e.format = function (d, M) {
              if (((M += ""), (d += ""), d.charAt(0) == "#"))
                return (
                  (this.startRGB = L(M)),
                  (this.endRGB = L(d)),
              ...
              if (!this.unit) {
                var D = M.replace(P, ""),
                  ne = d.replace(P, "");
                D !== ne && A("tween", M, d), (this.unit = D);
              }
              (M = parseFloat(M)),
                (d = parseFloat(d)),
                (this.begin = this.value = M),
                (this.change = d - M);
            }),
            (e.destroy = function () {
              this.stop(),
      ...
      var n = t.style,
        ...
        p = {
          ...
          "max-height": [S, F],
          "line-height": [S, ue],
          "scroll-top": [Ae, h, "scrollTop"],
          "scroll-left": [Ae, h, "scrollLeft"],
        },
        J = {};
      m.transform &&
        ((p.transform = [Ie]),
    ...
    Qe.define(
      ...
      (ht.exports = function (t, c, l) {
        ...
        function N(k) {
          return k.indexOf("//") >= 0
            ? k
            : P("https://editor-api.webflow.com" + k);
        }
        function P(k) {
        ...
        function t(l) {
          ...
          function W(h) {
            var k = h.type,
              E = h.tagName;
            return !!(
              (E === "INPUT" && I[k] && !h.readOnly) ||
              (E === "TEXTAREA" && !h.readOnly) ||
              h.isContentEditable
            );
          }
          function B(h) {
          ...
          function O(h) {
            A(h.target) && (L || W(h.target)) && B(h.target);
          }
          function K(h) {
            A(h.target) &&
      ...
      (bt.exports = function (t, c) {
        ...
        function O() {
          (z = y && Me.env("design")),
            ...
            Me.scroll.off(U),
            (H = []);
          for (var P = document.links, T = 0; T < P.length; ++T) K(P[T]);
          H.length && (Me.scroll.on(U), U());
        }
        function K(P) {
          if (!(P.dataset && P.dataset.wfCurrentLocale)) {
            var T =
              (z && P.getAttribute("href-disabled")) || P.getAttribute("href");
            if (((A.href = T), !(T.indexOf(":") >= 0))) {
              ...
              if (
                ...
                var k = t(A.hash);
                k.length && H.push({ link: h, sec: k, active: !1 });
                return;
              }
              if (!(T === "#" || T === "")) {
                var E =
          ...
          c.each(H, function (h) {
            if (
              !(
                h.link[0] &&
                h.link[0].dataset &&
                h.link[0].dataset.wfCurrentLocale
              )
            ) {
              var k = h.link,
                E = h.sec,
                ...
                te = E.outerHeight(),
                ue = T * 0.5,
                he = E.is(":visible") && F + te - ue >= P && F + ue <= P + T;
              h.active !== he && ((h.active = he), N(k, W, he));
            }
          });
        }
        function N(P, T, h) {
          var k = P.hasClass(T);
          (h && k) || (!h && !k) || (h ? P.addClass(T) : P.removeClass(T));
        }
        return l;
      })
    );
      ...
      (kt.exports = function (t) {
        ...
        function L(y) {
          ...
          function H(N) {
            ...
            (P && P.length > 1) ||
              ((I = !0),
              P ? ((A = !0), (B = P[0].clientX)) : (B = N.clientX),
              (Z = B));
          }
          function X(N) {
            if (I) {
              ...
              var P = N.touches,
                T = P ? P[0].clientX : N.clientX,
                h = T - Z;
              (Z = T),
                Math.abs(h) > W &&
                  l &&
                  String(l()) === "" &&
                  (z("swipe", N, { direction: h > 0 ? "right" : "left" }), K());
            }
          }
          function O(N) {
    ...
    Oe.define(
      ...
      (qt.exports = function (t, c) {
        ...
        function a(n) {
          var v = {},
            b = n.config || {},
            p = (v.animation = n.el.attr("data-animation") || "default");
          (v.animOver = /^over/.test(p)),
            (v.animDirect = /left$/.test(p) ? -1 : 1),
        ...
        function fe(n) {
          return function (v) {
            var b = t(this),
              p = b.attr("href");
            if (!Oe.validClick(v.currentTarget)) {
              v.preventDefault();
              return;
            }
        ...
        function Ae(n) {
          ...
          return (
            v === "none" && (v = ""),
            function (b, p) {
              (p = t(p)), p.css(oe, ""), p.css(oe) === "none" && p.css(oe, v);
            }
          );
        }
        function Ie(n, v) {
        ...
        function ke(n, v) {
          ...
          (n.open = !0),
            ...
            n.dropdownList.addClass(P),
            n.button.addClass(K);
          var b = n.config,
            p = b.animation;
          (p === "none" || !L.support.transform || b.duration <= 0) && (v = !0);
          var J = We(n),
        ...
        function We(n) {
          var v = n.config,
            b = v.docHeight ? y.height() : A.height();
          return (
            v.animOver
              ? n.menu.height(b)
